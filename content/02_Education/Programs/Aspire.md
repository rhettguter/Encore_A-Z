...
[[0.0 - The Stages of Encore]] is built as a production pathway — [[0.0 - Junior Stages|Junior Stages]] ([[Camps]] → [[Junior Shows]] → [[Emerging Artist Shows]]) leading into [[0.0 - Signature Stages|Signature Stages]] ([[Signature Shows]] → [[Show with a Pro]]). Each step is a discrete production a young artist auditions for, is cast in, rehearses, and performs.
