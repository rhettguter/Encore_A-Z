...
> - **Build the [[0.0 - Show Bible|Show Bible]].** It's your prompt book and the production's source of truth.
...
- **Documentation** — Build and maintain the [[0.0 - Show Bible|Show Bible]] (your prompt book), rehearsal reports, daily calls, performance reports, and the suite of tracking documents.
...
- Familiarity with Encore's [[0.0 - Production Bible|Production Bible]] framework.
...
- A [[0.0 - Show Bible|Show Bible]] complete, accurate, and usable by a substitute SM if needed.
...
- An [[Assistant Stage Manager|ASM]] who's grown in the role and is ready for more responsibility next time.
...
Work with the Director, [[Music Supervisor Director|Music Director]], and Choreographer to prepare for auditions:
...
- Prepare audition packets ([[Audition Form|audition form]] stapled over resume and headshot)
...
A recommended template for character scene breakdowns can be found [HERE](https://docs.google.com/spreadsheets/d/1K6qxY4Y3qpY0P7l_UXmaEX1iI9RhHUHX/edit?gid=1010211833#gid=1010211833).
...
#### The [[0.0 - Show Bible|Show Bible]] Preparation

Your prompt book or "show Bible" should be completely prepared before technical rehearsals begin. For detailed guidance on creating a comprehensive show Bible, refer to [[0.0 - Show Bible|Show Bible]].
...
- [[0.0 - Show Bible|Show Bible]] — the prompt book / definitive production reference
