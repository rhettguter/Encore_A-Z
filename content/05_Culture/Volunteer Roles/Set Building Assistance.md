...
This is an assistant to the [[Set Builder|set builder]] and the set builder should be the source for questions and concerns when building the set.

1.  > **Reading and Interpreting Set Designs**

      - Review set design plans, blueprints, and models provided by the [[01_Production/Roles/Design Team/Set Designer|set designer]] or [[Production Manager|production manager]].
...
8.  > **Collaboration and Communication**
      ...
      - Work closely with the [[01_Production/Roles/Design Team/Set Designer|set designer]], director, and other parent volunteers to ensure cohesive and efficient set construction.
